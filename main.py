...
def simulate_game(show_game, name="", net=None, routine=None):
    ...
    fitness = gamerun.alien_kills * 10 + gamerun.spaceship_kills * 50 + sum([health / 50 for health in gamerun.battleship_healths]) + sum([gamerun.alien_health - alien.health for alien in gamerun.aliens]) + sum([50 - enemy_spaceship.health for enemy_spaceship in gamerun.enemy_spaceships])

    print(f"{fitness} -> {gamerun.level} {gamerun.alien_kills} {gamerun.spaceship_kills} {gamerun.frames} {gamerun.battleship_healths} {sum([health / 50 for health in gamerun.battleship_healths])} {sum([gamerun.alien_health - alien.health for alien in gamerun.aliens])} {sum([50 - enemy_spaceship.health for enemy_spaceship in gamerun.enemy_spaceships])}")
